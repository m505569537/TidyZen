    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.helpArea}>
          ...
          <TouchableOpacity style={styles.helpBtnPrimary} activeOpacity={0.8} onPress={() => Linking.openURL('mailto:support@tidyzen.app?subject=联系客服').catch(() => Alert.alert('打开失败', '请检查是否已配置邮件 App'))}>
            <Text style={styles.helpBtnPrimaryText}>{'在线联系客服'}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.helpBtnSecondary} activeOpacity={0.8} onPress={() => Linking.openURL('mailto:feedback@tidyzen.app?subject=反馈建议').catch(() => Alert.alert('打开失败', '请检查是否已配置邮件 App'))}>
