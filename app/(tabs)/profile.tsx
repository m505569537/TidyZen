      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.levelRow}>
          ...
          <View style={styles.titleCard}>
            <MaterialIcons name='military-tech' size={28} color={colors.warmAmber} />
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 120, height: 120, borderRadius: 60, backgroundColor: '#B2DFDB', alignItems: 'center', justifyContent: 'center' },
  ...
  medalCircle: { width: 48, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center' },
