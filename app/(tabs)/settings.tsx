  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.groupCard}>
          <SettingItem icon="help-outline" label="常见问题" iconBg='#E3F2FD' iconColor='#2196F3' onPress={() => router.push('/help')} />
          <SettingItem icon="info-outline" label="关于 TidyZen" iconBg='#E3F2FD' iconColor='#2196F3'
            right={<View style={styles.rightRow}><Text style={styles.hintText}>v2.1.0</Text><MaterialIcons name="chevron-right" size={22} color={colors.outline} /></View>}
...
const styles = StyleSheet.create({
  ...
  header: { alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.pageMargin, paddingVertical: spacing.md },
