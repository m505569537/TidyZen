...
const SUGGESTIONS_DB: Record<ScenarioId, Suggestion[]> = {
  ...
  S02: [
    {
      ...
      video_id: 'S02-A01', // 视频占位符，待接入真实资源
    },
    {
  ...
  S03: [
    {
      ...
      video_id: 'S03-A01', // 视频占位符，待接入真实资源
    },
    {
  ...
  S04: [
    ...
    },
    {
      ...
      video_id: 'S04-A02', // 视频占位符，待接入真实资源
    },
  ],
  S05: [
    {
      ...
      video_id: 'S05-A01', // 视频占位符，待接入真实资源
    },
    {
  ...
  S06: [
    ...
    },
    {
      ...
      video_id: 'S06-A02', // 视频占位符，待接入真实资源
    },
  ],
  S07: [
    {
      ...
      video_id: 'S07-A01', // 视频占位符，待接入真实资源
    },
    {
      ...
      video_id: 'S07-A02', // 视频占位符，待接入真实资源
    },
  ],
  S08: [
    {
      ...
      video_id: 'S08-A01', // 视频占位符，待接入真实资源
    },
    {
  ...
  S09: [
    {
      ...
      video_id: 'S09-A01', // 视频占位符，待接入真实资源
    },
    {
  ...
  S10: [
    {
      ...
      video_id: 'S10-A01', // 视频占位符，待接入真实资源
    },
    {
      ...
      video_id: 'S10-A02', // 视频占位符，待接入真实资源
    },
  ],
};
